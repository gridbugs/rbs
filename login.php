...
Please note, <strong>group bookings (more than <?=$max_booked_seats?> seats)</strong> are eligible for a group discount.<br/><em>Group bookings cannot be made online</em> &mdash; please see the <a href='<?=$production['faqlocation']?>#group_bookings'>FAQ</a> for more information or <a href='malto:tickets@cserevue.org.au'>contact the Sales Team</a>.
</p>
<? } ?>
</div>
